...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.emojiDialog = function() {
			...
			var dialogContent = [
				"<div class=\"" + classPrefix + "emoji-dialog-box\" css=\"width: 760px;height: 334px;margin-bottom: 8px;overflow: hidden;\">",
			...
			if (tab.html() === "") 
			{
				...
				for (var x = 0; x < 4; x++) 
                {
					...
					container += "<div class=\"" + classPrefix + "tab-box\" css=\"height: 260px;overflow: hidden;overflow-y: auto;" + display + "\"></div>";
				}
			...
			var drawTable = function() {
                        ...
                        for (var x = 0; x < rowNumber; x++)
                        {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "")
                            {
                                ...
                                else if (type === "editormd-logo")
                                {
                                    ...
                                    row += "<a href=\"javascript:;\" value=\":" + emoji + ":\" title=\":" + emoji + ":\" css=\"width:20%;\" class=\"" + classPrefix + "emoji-btn\">" + icon + "</a>";
                                }
                            }
                            else
                            {
                ...
                if (emojiTabIndex === 0)
                {
                    ...
                    {
                        var h4Style = (i === 0) ? " css=\"margin: 0 0 10px;\"" : " css=\"margin: 10px 0;\"";
