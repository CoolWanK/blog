...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.gotoLineDialog = function() {
			...
			{			
				var dialogContent = [
					"<div class=\"editormd-form\" css=\"padding: 10px 0;\">",
					"<p css=\"margin: 0;\">" + dialogLang.label + " 1-" + lineCount +"&nbsp;&nbsp;&nbsp;<input type=\"number\" class=\"number-input\" css=\"width: 60px;\" value=\"1\" max=\"" + lineCount + "\" min=\"1\" data-line-number /></p>",
					"</div>"
				].join("\n");
