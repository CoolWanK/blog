...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.tableDialog = function() {
			...
			var dialogContent = [
				"<div class=\"editormd-form\" css=\"padding: 13px 0;\">",
				"<label>" + dialogLang.cellsLabel + "</label>",
				dialogLang.rows + " <input type=\"number\" value=\"3\" class=\"number-input\" css=\"width:40px;\" max=\"100\" min=\"2\" data-rows />&nbsp;&nbsp;",
				dialogLang.cols + " <input type=\"number\" value=\"2\" class=\"number-input\" css=\"width:40px;\" max=\"100\" min=\"1\" data-cols /><br/>",
